...
import filePick from './directives/file_pick';
...
import messageContextmenu from './directives/message_contextmenu';
import messageDate from './directives/message_date';
import messageGroupReactions from './directives/message_group_reactions';
import messageEmojiReactions from './directives/message_emoji_reactions';
...
import messageTailTint from './directives/message_tail_tint';
...
angular.module('3ema.directives').directive('eeeFilePick', filePick);
...
angular.module('3ema.directives').directive('eeeMessageContextmenu', messageContextmenu);
angular.module('3ema.directives').directive('eeeMessageDate', messageDate);
angular.module('3ema.directives').directive('eeeMessageGroupReactions', messageGroupReactions);
angular.module('3ema.directives').directive('eeeMessageEmojiReactions', messageEmojiReactions);
...
angular.module('3ema.directives').directive('eeeMessageTailTint', messageTailTint);
