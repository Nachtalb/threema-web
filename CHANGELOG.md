...
* [change] Replace 128-bit fingerprint with 256-bit public key ([#1093][i1093])
...
`window.UserConfig.MYVAR = 'myvalue';` to the `userconfig.js` file. See
`docker/entrypoint.sh` if you need an example.
...
[i1093]: https://github.com/threema-ch/threema-web/issues/1093
